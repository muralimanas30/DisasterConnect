            ...
            <div className="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <input type="text" id="username" name="username" required className="text-black w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500" />
                    </div>
                    <div>
                        <label htmlFor="email" className="block mb-1 font-semibold text-gray-700">Email</label>
                        <input type="email" id="email" name="email" required className="w-full text-black px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500" />
                    </div>
                    <div>
                        <label htmlFor="phoneNumber" className="block mb-1 font-semibold text-gray-700">Phone Number</label>
                        <input type="tel" id="phoneNumber" name="phoneNumber" required className="w-full px-4 text-black py-2 border rounded-lg focus:ring-2 focus:ring-blue-500" />
                    </div>
                    <div>
                        <label htmlFor="password" className="block mb-1 font-semibold text-gray-700">Password</label>
                        <input type="password" id="password" name="password" required className="w-full px-4 py-2 text-black border rounded-lg focus:ring-2 focus:ring-blue-500" />
                    </div>
                    <div>
                        ...
                        <div className="flex justify-around">
                            <label className="text-black inline-flex items-center gap-2">
                                <input type="radio" id="role-victim" name="role" value="victim" required className="text-black  accent-blue-600" />
                                Victim
                            </label>
                            <label className="text-black inline-flex items-center gap-2">
                                <input type="radio" id="role-ngo" name="role" value="admin" className="text-black accent-blue-600" />
                                Admin
                            </label>
                            <label className="text-black inline-flex items-center gap-2">
                                <input type="radio" id="role-volunteer" name="role" value="volunteer" className="text-black accent-blue-600" />
                                Volunteer
                            </label>
                        </div>
                    </div>
